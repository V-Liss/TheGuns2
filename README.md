 ...
 * **saving:** a save.txt file. The game writes serialized data of your ammo, crafting materials, blueprints, weapons, etc. into a long vertical table of numbers when you finish a level, and reads them when you enter the game.
